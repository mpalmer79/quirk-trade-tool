...
// Appraise endpoint rate limit
const appraiseLimiter = rateLimit({
  windowMs: 60 * 1000, // 1 minute
  max: 30, // 30 appraisals per minute per IP
  message: 'Too many appraisals requested, please try again later',
  keyGenerator: (req) => {
...
// Appraisal routes
app.use('/api/appraise', appraiseLimiter, appraiseRoute);
...
// Valuation routes
app.use('/api/valuations', valuationsRoute);
